...
public class DeviceControllerActivity extends Activity {
    ...
    private final static String TAG = DeviceControllerActivity.class
            .getSimpleName();
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
       ...
       //     Object rssi=intent.getParcelableExtra(BluetoothDevice.EXTRA_RSSI);
          //  System.out.println("Rssi is : "+rssi);
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //  mDeviceRssi = intent.getStringExtra(EXTRA_RSSI);
        // Sets up UI references.
        ((TextView) findViewById(R.id.device_address)).setText(mDeviceAddress);
        ((TextView) findViewById(R.id.device_rssi)).setText(mDeviceRssi);
